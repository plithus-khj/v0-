          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="md:w-64 md:sticky md:top-4 self-start">
              <TabsList className="flex-col h-auto bg-transparent space-y-2 w-full overflow-y-auto max-h-[calc(100vh-200px)]">
                <TabsTrigger
                  value="overview"
                  className="w-full justify-start tab-trigger-overview text-gray-400 data-[state=active]:text-black"
                ...
                <TabsTrigger
                  ...
                  className="w-full justify-start tab-trigger-multiple-choice text-gray-400 data-[state=active]:text-black"
                ...
                <TabsTrigger
                  value="open-ended"
                  className="w-full justify-start tab-trigger-open-ended text-gray-400 data-[state=active]:text-black"
                ...
                <TabsTrigger
                  value="sentiment"
                  className="w-full justify-start tab-trigger-sentiment text-gray-400 data-[state=active]:text-black"
                ...
                <TabsTrigger
                  value="bugs"
                  className="w-full justify-start tab-trigger-bugs text-gray-400 data-[state=active]:text-black"
                ...
                <TabsTrigger
                  ...
                  className="w-full justify-start tab-trigger-cross-analysis text-gray-400 data-[state=active]:text-black"
                ...
                <TabsTrigger
                  value="insights"
                  className="w-full justify-start tab-trigger-insights text-gray-400 data-[state=active]:text-black"
                ...
                <TabsTrigger
                  ...
                  className="w-full justify-start tab-trigger-feedback-viewer text-gray-400 data-[state=active]:text-black"
